...
(function () {
    ...
    function calculate() {
        ...
        // Emergency fund bar — savings field is prefilled from the session so this reflects actual progress
    ...
    /*  Retrieves difficulty and financial values from the API
        ...
        Wires input event listeners
        Prefills session values
        Runs calculate()
    */
    (function loadFinancials() {
        fetch('/api/financials')
            ...
            .then(function (data) {
                ...
                // Recalculate so the chart, summary, and emergency fund bar all reflect prefilled values
                calculate();
            })
            .catch(function () {
    ...
    // Reset button — clears all income and expense inputs, then recalculates
